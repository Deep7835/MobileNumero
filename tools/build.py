...
UI = {
 'en': dict(calc='Calculators', home='Home', blog='Blog', tools='Quick tools', buy='Buy a number', numbers='Birth numbers', free='Free analysis', skip='Skip to content', minread='{n} min read', by='By Deepam Mishra', inthis='In this article', faq='Frequently asked questions', related='Related articles', blogtitle='Mobile Numerology Blog: Lucky Numbers, PINs & Passwords', blogdesc='Practical mobile numerology guides: what each digit position means, lucky number endings, Lo Shu grid, PIN and password rules, wallpaper, cover and colour by date of birth.', blogh1='Inside numerology: guides, rules and lucky numbers', blogintro='Practical guides to mobile numerology: how to read every digit of your phone number, choose a lucky PIN and password, and align your wallpaper, cover and colour with your date of birth.', disclaimer='<strong>Disclaimer:</strong> Numerology is a belief-based practice offered for guidance and entertainment. It is not medical, legal or financial advice. Never share your real PIN or password with anyone — the calculators here run only in your browser.', credit='Content based on traditional mobile numerology methods, compiled and explained in our own words.', privacy='Privacy Policy', terms='Terms &amp; Conditions', sitemap='Sitemap', expert='Talk to an expert', cta='Get my free analysis', readin='Read this article in', imgalt='{t} — illustration', dateloc='en_IN'),
 'hi': dict(calc='कैलकुलेटर', home='होम', blog='ब्लॉग', tools='त्वरित टूल', buy='नंबर खरीदें', numbers='मूलांक 1–9', free='मुफ़्त विश्लेषण', skip='सामग्री पर जाएँ', minread='{n} मिनट पढ़ें', by='दीपम मिश्रा द्वारा', inthis='इस लेख में', faq='अक्सर पूछे जाने वाले प्रश्न', related='संबंधित लेख', blogtitle='मोबाइल न्यूमरोलॉजी ब्लॉग — शुभ नंबर, पिन, पासवर्ड', blogdesc='व्यावहारिक मोबाइल न्यूमरोलॉजी गाइड: हर अंक पोज़ीशन का अर्थ, शुभ नंबर अंत, लो-शू ग्रिड, पिन और पासवर्ड नियम, जन्मतिथि के अनुसार वॉलपेपर, कवर और रंग।', blogh1='न्यूमरोलॉजी की दुनिया: गाइड, नियम और शुभ अंक', blogintro='मोबाइल न्यूमरोलॉजी के व्यावहारिक गाइड: अपने फ़ोन नंबर का हर अंक कैसे पढ़ें, शुभ पिन और पासवर्ड कैसे चुनें, और अपनी जन्मतिथि के अनुसार वॉलपेपर, कवर और रंग कैसे मिलाएँ।', disclaimer='<strong>अस्वीकरण:</strong> न्यूमरोलॉजी एक आस्था-आधारित पद्धति है जो मार्गदर्शन और मनोरंजन के लिए है। यह चिकित्सा, कानूनी या वित्तीय सलाह नहीं है। अपना असली पिन या पासवर्ड कभी किसी से साझा न करें — यहाँ के कैलकुलेटर केवल आपके ब्राउज़र में चलते हैं।', credit='सामग्री पारंपरिक मोबाइल न्यूमरोलॉजी पद्धतियों पर आधारित है, हमारे अपने शब्दों में संकलित।', privacy='गोपनीयता नीति', terms='नियम और शर्तें', sitemap='साइटमैप', expert='विशेषज्ञ से बात करें', cta='मेरा मुफ़्त विश्लेषण पाएँ', readin='इस लेख को पढ़ें', imgalt='{t} — चित्रण', dateloc='hi_IN'),
 'mr': dict(calc='कॅल्क्युलेटर', home='होम', blog='ब्लॉग', tools='झटपट साधने', buy='नंबर खरेदी करा', numbers='मूलांक 1–9', free='मोफत विश्लेषण', skip='मजकुराकडे जा', minread='{n} मिनिटे वाचन', by='दीपम मिश्रा यांच्याकडून', inthis='या लेखात', faq='वारंवार विचारले जाणारे प्रश्न', related='संबंधित लेख', blogtitle='मोबाइल न्यूमरॉलॉजी ब्लॉग — शुभ नंबर, पिन, पासवर्ड', blogdesc='व्यावहारिक मोबाइल न्यूमरॉलॉजी मार्गदर्शक: प्रत्येक अंक स्थानाचा अर्थ, शुभ नंबर शेवट, लो-शू ग्रिड, पिन व पासवर्ड नियम, जन्मतारखेनुसार वॉलपेपर, कव्हर आणि रंग.', blogh1='न्यूमरॉलॉजीच्या आत: मार्गदर्शक, नियम आणि शुभ अंक', blogintro='मोबाइल न्यूमरॉलॉजीचे व्यावहारिक मार्गदर्शक: तुमच्या फोन नंबरचा प्रत्येक अंक कसा वाचावा, शुभ पिन व पासवर्ड कसा निवडावा, आणि जन्मतारखेनुसार वॉलपेपर, कव्हर व रंग कसे जुळवावे.', disclaimer='<strong>अस्वीकरण:</strong> न्यूमरॉलॉजी ही श्रद्धेवर आधारित पद्धत असून ती मार्गदर्शन व मनोरंजनासाठी आहे. हा वैद्यकीय, कायदेशीर किंवा आर्थिक सल्ला नाही. तुमचा खरा पिन किंवा पासवर्ड कधीही कोणाशी शेअर करू नका — येथील कॅल्क्युलेटर फक्त तुमच्या ब्राउझरमध्ये चालतात.', credit='मजकूर पारंपरिक मोबाइल न्यूमरॉलॉजी पद्धतींवर आधारित, आमच्या स्वतःच्या शब्दांत मांडलेला.', privacy='गोपनीयता धोरण', terms='अटी व शर्ती', sitemap='साइटमॅप', expert='तज्ज्ञांशी बोला', cta='माझे मोफत विश्लेषण मिळवा', readin='हा लेख वाचा', imgalt='{t} — चित्र', dateloc='mr_IN'),
 'ta': dict(calc='கால்குலேட்டர்கள்', home='முகப்பு', blog='வலைப்பதிவு', tools='விரைவு கருவிகள்', buy='எண் வாங்க', numbers='பிறப்பு எண்கள்', free='இலவச ஆய்வு', skip='உள்ளடக்கத்திற்குச் செல்', minread='{n} நிமிட வாசிப்பு', by='தீபம் மிஸ்ரா எழுதியது', inthis='இந்தக் கட்டுரையில்', faq='அடிக்கடி கேட்கப்படும் கேள்விகள்', related='தொடர்புடைய கட்டுரைகள்', blogtitle='மொபைல் எண் கணித வலைப்பதிவு — அதிர்ஷ்ட எண்கள், பின்', blogdesc='நடைமுறை மொபைல் எண் கணித வழிகாட்டிகள்: ஒவ்வொரு இலக்க இடத்தின் அர்த்தம், அதிர்ஷ்ட எண் முடிவுகள், லோ ஷூ கட்டம், பின் மற்றும் கடவுச்சொல் விதிகள், பிறந்த தேதிப்படி வால்பேப்பர், கவர் மற்றும் நிறம்.', blogh1='எண் கணிதத்தின் உள்ளே: வழிகாட்டிகள், விதிகள், அதிர்ஷ்ட எண்கள்', blogintro='மொபைல் எண் கணிதத்திற்கான நடைமுறை வழிகாட்டிகள்: உங்கள் ஃபோன் எண்ணின் ஒவ்வொரு இலக்கத்தையும் எப்படிப் படிப்பது, அதிர்ஷ்ட பின் மற்றும் கடவுச்சொல்லைத் தேர்வு செய்வது, பிறந்த தேதிக்கு ஏற்ப வால்பேப்பர், கவர் மற்றும் நிறத்தை அமைப்பது.', disclaimer='<strong>மறுப்பு:</strong> எண் கணிதம் என்பது வழிகாட்டுதல் மற்றும் பொழுதுபோக்கிற்காக வழங்கப்படும் நம்பிக்கை அடிப்படையிலான நடைமுறை. இது மருத்துவ, சட்ட அல்லது நிதி ஆலோசனை அல்ல. உங்கள் உண்மையான பின் அல்லது கடவுச்சொல்லை யாருடனும் பகிராதீர்கள் — இங்குள்ள கால்குலேட்டர்கள் உங்கள் உலாவியில் மட்டுமே இயங்கும்.', credit='உள்ளடக்கம் பாரம்பரிய மொபைல் எண் கணித முறைகளை அடிப்படையாகக் கொண்டு, எங்கள் சொந்த வார்த்தைகளில் தொகுக்கப்பட்டது.', privacy='தனியுரிமைக் கொள்கை', terms='விதிமுறைகள்', sitemap='தளவரைபடம்', expert='நிபுணரிடம் பேசுங்கள்', cta='என் இலவச ஆய்வைப் பெறு', readin='இந்தக் கட்டுரையைப் படிக்க', imgalt='{t} — விளக்கப்படம்', dateloc='ta_IN'),
 'gu': dict(calc='કેલ્ક્યુલેટર', home='હોમ', blog='બ્લોગ', tools='ઝડપી સાધનો', buy='નંબર ખરીદો', numbers='મૂળાંક 1–9', free='મફત વિશ્લેષણ', skip='સામગ્રી પર જાઓ', minread='{n} મિનિટ વાંચન', by='દીપમ મિશ્રા દ્વારા', inthis='આ લેખમાં', faq='વારંવાર પૂછાતા પ્રશ્નો', related='સંબંધિત લેખો', blogtitle='મોબાઇલ ન્યુમરોલોજી બ્લોગ — શુભ નંબર, પિન, પાસવર્ડ', blogdesc='વ્યવહારુ મોબાઇલ ન્યુમરોલોજી માર્ગદર્શિકાઓ: દરેક અંક પોઝિશનનો અર્થ, શુભ નંબર અંત, લો-શુ ગ્રિડ, પિન અને પાસવર્ડ નિયમો, જન્મતારીખ મુજબ વૉલપેપર, કવર અને રંગ.', blogh1='ન્યુમરોલોજીની અંદર: માર્ગદર્શિકાઓ, નિયમો અને શુભ અંકો', blogintro='મોબાઇલ ન્યુમરોલોજીની વ્યવહારુ માર્ગદર્શિકાઓ: તમારા ફોન નંબરનો દરેક અંક કેવી રીતે વાંચવો, શુભ પિન અને પાસવર્ડ કેવી રીતે પસંદ કરવો, અને જન્મતારીખ મુજબ વૉલપેપર, કવર અને રંગ કેવી રીતે મેળવવા.', disclaimer='<strong>અસ્વીકરણ:</strong> ન્યુમરોલોજી એ માર્ગદર્શન અને મનોરંજન માટે આપવામાં આવતી શ્રદ્ધા-આધારિત પદ્ધતિ છે. તે તબીબી, કાનૂની કે નાણાકીય સલાહ નથી. તમારો ખરો પિન કે પાસવર્ડ ક્યારેય કોઈ સાથે શેર ન કરો — અહીંના કેલ્ક્યુલેટર ફક્ત તમારા બ્રાઉઝરમાં ચાલે છે.', credit='સામગ્રી પરંપરાગત મોબાઇલ ન્યુમરોલોજી પદ્ધતિઓ પર આધારિત, અમારા પોતાના શબ્દોમાં સંકલિત.', privacy='ગોપનીયતા નીતિ', terms='નિયમો અને શરતો', sitemap='સાઇટમેપ', expert='નિષ્ણાત સાથે વાત કરો', cta='મારું મફત વિશ્લેષણ મેળવો', readin='આ લેખ વાંચો', imgalt='{t} — ચિત્ર', dateloc='gu_IN'),
}
...
def expand_icons(html_, depth):
    """{{ico:name}} placeholders (used inside post bodies) -> inline sprite icons with the right relative path."""
    return re.sub(r'\{\{ico:([a-z-]+)\}\}', lambda m: ICON(m.group(1), '../' * depth), html_)

def write_page(path, html_):
    depth = len(path.relative_to(ROOT).parts) - 1
    path.write_text(clean_urls(expand_icons(html_, depth)))
...
def short_title(t, limit=60):
    """Trim a headline for the <title> tag: drop a trailing parenthetical, then a ' — ' or ': ' subtitle, while it stays meaningful."""
    if len(t) <= limit: return t
    for pat in (r'\s*\([^()]*\)\s*$', r'\s+—\s+[^—]*$', r':\s+[^:]*$'):
        cut = re.sub(pat, '', t).strip()
        if 20 <= len(cut) < len(t): t = cut
...
def head(title, desc, canonical_path, og_image, extra_ld='', article=None, depth=1, lang='en', alternates=None):
    ...
    ld = [{"@type": "WebSite", "name": SITE_NAME, "url": SITE_URL + '/'},
          {"@type": "Organization", "@id": SITE_URL + '/#org', "name": SITE_NAME, "url": SITE_URL + '/', "logo": f"{SITE_URL}/assets/icon-512.png", "founder": {"@type": "Person", "@id": SITE_URL + '/about#person', "name": AUTHOR}}]
    if article:
...
<head>
  ...
  <title>{esc(short_title(title))}</title>
  ...
  <div class="container">
    <div class="footer-cta">
      <div>
        ...
        <h2>{u['f_cta_h']}</h2>
        <p>{u['f_cta_p']}</p>
        <a class="btn" href="{anchor}"><span>{u['f_cta_btn']}</span>{ICON("arrow-up-right", up)}</a>
      </div>
      <div class="rings" aria-hidden="true">
        ...
        <span class="core"><img src="{up}assets/logo-mark.png" width="52" height="52" alt="{SITE_NAME} logo" /></span>{orbs}
      </div>
    </div>
  </div>
  <div class="footer-main">
    <div class="container">
      <div class="footer-grid">
        ...
        <div>
          ...
          <ul>
            ...
            <li><a href="#" data-whatsapp target="_blank" rel="noopener">{u['f_expert']} <span class="ext">{ICON("arrow-up-right", up)}</span></a></li>
      ...
      <div class="footer-bottom">
        ...
        <div><span data-social-links></span>{u['f_made']} <span class="dot">·</span> <span class="credit">Design &amp; Developed by <a href="https://madssolution.com/" target="_blank" rel="noopener"><b>Mads Solutions</b></a></span></div>
      </div>
    </div>
  </div>
</footer>
<a class="btn sticky-cta" href="{anchor}">{ICON("sparkles", up)}<span>{u['cta']}</span></a>
<script src="{up}js/icons.js?{VER}"></script>
...
def index_page(lang='en'):
    ...
    author = lambda d: '<div class="byline"><span class="avatar"><img src="' + '../' * depth + 'assets/logo-mark.png" width="34" height="34" alt="' + SITE_NAME + '" /></span><div><b>' + SITE_NAME + '</b><span>' + fmt_date_l(d, lang) + '</span></div></div>'
    feat = posts[0]
...
def number_pages():
    ...
    for n, d in NUMBERS.items():
        ...
        title = f"Birth Number {n} ({d['planet']}): Lucky Mobile Number, PIN & Colour"
        ...
        covers = ''.join(f"<li><b>{ICON(c['icon'], '../')} {c['name']}</b> — {c['idealFor']}{(' Tip: ' + c['tip']) if c['tip'] else ''}</li>" for c in d['covers'])
...
def tool_pages():
    ...
    sidebar = lambda cur: '<aside class="tool-nav"><div class="tool-nav-head">Free calculators</div>' + ''.join(f'<a href="{t["slug"]}.html" class="{"active" if t["slug"] == cur else ""}">{ICON(t["icon"], "../")}{t["name"]}</a>' for t in TOOLS) + '<a href="../index.html#mainForm">' + ICON("smartphone", "../") + 'Mobile number analyser</a></aside>'
...
def inject_static_footers():
    ...
    for name in ['index.html', 'about.html', 'privacy.html', 'terms.html', '404.html']:
        ...
        if name == 'index.html':
            ...
            u = UI['en']
            for key, val in [('f_cta_eye', u['f_cta_eye']), ('f_cta_h', u['f_cta_h']), ('f_cta_p', u['f_cta_p']), ('f_tag', u['f_tag']), ('f_explore', u['f_explore']), ('f_company', u['f_company']), ('f_rights', u['f_rights']), ('f_made', u['f_made']), ('f_expert', u['f_expert']), ('f_analyser', u['f_analyser'])]:
                body = body.replace(f'>{val}<', f' data-i18n="{key}">{val}<', 1).replace(f'>{val} <span', f' data-i18n-html="{key}_x">{val} <span', 1)
            body = body.replace(f"<span>{u['f_cta_btn']}</span>", f"<span data-i18n=\"f_cta_btn_x\">{u['f_cta_btn']}</span>")
