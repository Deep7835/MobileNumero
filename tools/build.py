...
<footer>
  <div class="container">
    <p>{u['disclaimer']}</p>
    <p>{u['credit']}</p>
    <div class="footer-links"><a href="{up}{'' if lang == 'en' else lang + '/'}blog/">{u['blog']}</a><a href="{up}tools/">{u['calc']}</a><a href="{up}privacy.html">{u['privacy']}</a><a href="{up}terms.html">{u['terms']}</a><a href="{up}sitemap.xml">{u['sitemap']}</a><a href="#" data-whatsapp target="_blank" rel="noopener">{u['expert']}</a></div>
  </div>
</footer>
