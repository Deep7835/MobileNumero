...
const DATA = {
  ...
  pins: [
    ...
    { purpose: 'Education',            pin: '3767',  total: 5 },
    ...
    { purpose: 'Business growth',      pin: '5559',  total: 6 },
    ...
    { purpose: 'Peace of mind',        pin: '4456',  total: 1 },
  ...
  passwords: {
    1: { purpose: 'Name & fame, leadership',            examples: ['GURUJI', 'TILK', 'RAIIN', 'REDROSE'] },
    2: { purpose: 'Intuition, emotions',                examples: ['SAIBABA', 'MANGO', 'PAPAYA'] },
    3: { purpose: 'Education, research work',           examples: ['RHYTHM'] },
    ...
    8: { purpose: 'Property, court case',               examples: ['PINEAPPLE', 'ROSE', 'DATES', 'VISHNU'] },
    9: { purpose: 'Energy, restaurant business, sports',examples: ['HANUMAN'] },
  },

  /* ---------- PDF 12: Mobile covers ---------- */
  covers: [
    { id: 'silicone', name: 'Silicone / Gel / TPU', icon: 'droplets', bestFor: [2, 3, 6, 7], idealFor: 'Artists, empaths, teachers, healers',
    ...
    { id: 'plastic', name: 'Plastic', icon: 'snowflake', bestFor: [4, 5, 6, 8], idealFor: 'Calm, peace-loving people', tip: 'Keep pink or blue shades to open emotional flow.',
    ...
    { id: 'metal', name: 'Metal', icon: 'settings', bestFor: [1, 8, 9], idealFor: 'Career-driven, goal-oriented people', tip: 'Red or gold tones energise motivation positively.',
    ...
    { id: 'leather', name: 'Leather', icon: 'briefcase', bestFor: [1, 4, 6, 8], idealFor: 'Business owners, decision-makers, public figures',
    ...
    { id: 'rubber', name: 'Rubber', icon: 'circle-dot', bestFor: [2, 4, 6, 7], idealFor: 'Supportive listeners', tip: 'Use grounding crystals (e.g. Pyrite) with this cover.',
    ...
    { id: 'hybrid', name: 'Hybrid / Military-grade Armour', icon: 'shield', bestFor: [1, 4, 8, 9], idealFor: 'Leaders, security forces, lawyers, those needing strength',
    ...
    { id: 'hard', name: 'Hard & Tough', icon: 'box', bestFor: [1, 4, 8], idealFor: 'Managers, elders, solo decision-makers, serious-minded people',
    ...
    { id: 'flip', name: 'Flip / Wallet Case', icon: 'book', bestFor: [4, 6, 7, 8], idealFor: 'Teachers, advisors, consultants, introverts, caretakers',
    ...
    { id: 'pouch', name: 'Pouch Case', icon: 'wallet', bestFor: [8], idealFor: 'Senior professionals, introverts, thinkers, spiritual seekers',
